###########################################
# kali Linux boot script V1 for Android 3.2 and up  #

# Built by Anas Almathani (Anas_Almathani_737713100)   #
###########################################
# $ver: V1                                #
###########################################
...
# Set up variables                        #
###########################################
if [ -f /data/data/linuxonandroid/busybox ]; then
      	export bbox=/data/data/linuxonandroid/busybox
...
export usermounts=Anas_Almathani	# Base folder all user mounts are done in, should be moved to app later
